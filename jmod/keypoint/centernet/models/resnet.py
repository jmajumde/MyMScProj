...
from MyMScProj.jmod.keypoint.centernet.losses import loss
...
def centernet(num_classes, backbone='resnet50', input_size=512, max_objects=100, score_threshold=0.1,
    ...
    loss_, hm_loss, wh_loss, reg_loss = Lambda(loss, name='centernet_loss')(
    ...
    loss_dict = {"hm_loss": hm_loss, "wh_loss": wh_loss, "reg_loss": reg_loss}
    ...
    return model, prediction_model, debug_model, loss_dict
